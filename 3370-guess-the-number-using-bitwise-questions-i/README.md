<h2><a href="https://leetcode.com/problems/guess-the-number-using-bitwise-questions-i">Guess the Number Using Bitwise Questions I</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>There is a number <code>n</code> that you have to find.</p>
