<h2><a href="https://leetcode.com/problems/convert-doubly-linked-list-to-array-ii">3294. Convert Doubly Linked List to Array II</a></h2><h3>Medium</h3><hr><p>You are given an <strong>arbitrary</strong> <code>node</code> from a <strong>doubly linked list</strong>, which contains nodes that have a next pointer and a previous pointer.</p>
